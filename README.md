...
## 3. Расчет зарплаты
Для работы с зарплатными документами предварительно нужно установить оклад и процент оплаты выполненных работ для каждого сотрудника в регистре сведений "Условия оплаты труда", заполнить график работы с помощь обработки "Заполнение графика", указав период заполнение графика и выходные дни.
